...
if __name__ == '__main__':
    ...
    ax.text(-7, y0+3, "A: 1-1-1 scalar task", fontsize=12, va="bottom", weight="bold")
    ax.text(-7, y1+7, "B: 1-3-3 scalar task", fontsize=12, va="bottom", weight="bold")
    ax.text(-7, y2+5, "C: 3-1-1 scalar task", fontsize=12, va="bottom", weight="bold")
    ax.text(-7, y3+9, "D: 1-1-1 digit  task", fontsize=12, va="bottom", weight="bold")
